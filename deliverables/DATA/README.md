We decided to use books as our entity and used amazon and walmart as our web data sources. The data is stored in two files - amazon_books.csv and walmart_books.csv
